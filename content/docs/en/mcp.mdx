...
Zvec MCP Server provides vector database tools for MCP clients such as Claude Code and Qoder.
...
| --- | --- |
| &lt; 100K | `FLAT` |
| 100K – 10M | `HNSW` (recommended) |
| &gt; 10M | `IVF` |

Run `optimize_collection` after bulk writes to optimize the collection.
